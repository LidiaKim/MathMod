...
# lida=matrix(ncol=ncol(new.table)-1,nrow=nrow(new.table)-1)
# lida=new.table[2:51,2:6]
# colnames(lida)=new.table[1,2:6]
# rownames(lida)=new.table[2:51,1]
######
list.mean.col=list()
list.mean.row=list()
DNA=c()
